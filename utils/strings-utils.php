...
class HbStringsUtils {
	...
	public function get_coupons_txt() {
		return array(
			...
			'verifying_coupon' => esc_html__( 'Verifying coupon', 'hbook-admin' ),
	...
	public function get_summary_txt() {
		return array(
			...
			'summary_resa_details_subtitle' => esc_html( 'Reservation details', 'hbook-admin' ),
			...
			'summary_price_breakdown_subtitle' => esc_html__( 'Price breakdown', 'hbook-admin' ),
			...
			'summary_payments_history_subtitle' => esc_html__( 'Payments history', 'hbook-admin' ),
	...
	public function get_stripe_txt() {
		return array(
			...
			'stripe_payment_declined' => esc_html__( 'Declined payment', 'hbook-admin' ),
	...
	public function get_invoice_table_txt() {
		return array(
			...
			'table_invoice_accom_title' => esc_html__( 'Accommodation section title', 'hbook-admin' ),
			'table_invoice_discount' => esc_html__( 'Discount', 'hbook-admin' ),
			'table_invoice_surcharge' => esc_html__( 'Surcharge', 'hbook-admin' ),
			'table_invoice_accom_subtotal' => esc_html__( 'Accommodation subtotal', 'hbook-admin' ),
			'table_invoice_accom_total' => esc_html__( 'Accommodation total', 'hbook-admin' ),
			'table_invoice_accom_extras_total' => esc_html__( 'Accommodation and extras total', 'hbook-admin' ),
			'table_invoice_global_extras_title' => esc_html__( 'Global extra services section title', 'hbook-admin' ),
			'table_invoice_extras_title' => esc_html__( 'Extra services section title', 'hbook-admin' ),
			'table_invoice_extras_subtotal' => esc_html__( 'Extra services subtotal', 'hbook-admin' ),
			'table_invoice_extras_total' => esc_html__( 'Extra services total', 'hbook-admin' ),
			'table_invoice_global_extras_total' => esc_html__( 'Global extra services total', 'hbook-admin' ),
			'table_invoice_coupon' => esc_html__( 'Coupon', 'hbook-admin' ),
			'table_invoice_subtotal' => esc_html__( 'Subtotal', 'hbook-admin' ),
			'table_invoice_total' => esc_html__( 'Total', 'hbook-admin' ),
			'table_invoice_included_fee' => esc_html__( 'Included fee text', 'hbook-admin' ),
			'table_invoice_bond' => esc_html__( 'Security bond', 'hbook-admin' ),
			'table_invoice_total_with_bond' => esc_html__( 'Total including security bond', 'hbook-admin' ),
			'table_invoice_paid' => esc_html__( 'Amount paid', 'hbook-admin' ),
			'table_invoice_due' => esc_html__( 'Total due', 'hbook-admin' ),
		);
	}

	public function get_payments_history_table_txt() {
		return array(
			'table_payments_history_head_date' => esc_html__( 'Payment date table head', 'hbook-admin' ),
			'table_payments_history_head_method' => esc_html__( 'Payment method table head', 'hbook-admin' ),
			'table_payments_history_head_amount' => esc_html__( 'Amount table head', 'hbook-admin' ),
			'table_payments_history_total_paid' => esc_html__( 'Total amount paid', 'hbook-admin' ),
		);
	}
	...
	public function get_later_payment_form_txt() {
		return array(
			'later_payment_form_title' => esc_html__( 'Payment form title', 'hbook-admin' ),
			'later_payment_type_explanation' => esc_html__( 'Payment type (text before payment form)', 'hbook-admin' ),
			'later_payment_type_total_price' => esc_html__( 'Payment type: total price', 'hbook-admin' ),
			'later_payment_type_total_price_including_bond' => esc_html__( 'Payment type: total price including bond', 'hbook-admin' ),
			'later_payment_type_deposit' => esc_html__( 'Payment type: deposit', 'hbook-admin' ),
			'later_payment_type_deposit_including_bond' => esc_html__( 'Payment type: deposit including bond', 'hbook-admin' ),
			'later_payment_type_remaining_balance' => esc_html__( 'Payment type: remaining balance', 'hbook-admin' ),
			'later_payment_type_remaining_balance_including_bond' => esc_html__( 'Payment type: remaining balance including bond', 'hbook-admin' ),
			'later_payment_type_bond' => esc_html__( 'Payment type: bond', 'hbook-admin' ),
			'later_payment_form_amount' => esc_html__( 'Amount (text before payment form)', 'hbook-admin' ),
			'later_payment_form_store_credit_card_text_explanation' => esc_html__( 'Explanation text before add or update payment method form', 'hbook-admin' ),
			'later_payment_txt_before_pay_button' => esc_html__( 'Text before "Pay now" button', 'hbook-admin' ),
			'later_payment_form_pay_button' => esc_html__( 'Pay now button', 'hbook-admin' ),
			'later_payment_txt_before_submit_button' => esc_html__( 'Text before "Submit" button', 'hbook-admin' ),
			'later_payment_form_submit_button' => esc_html__( 'Submit button', 'hbook-admin' ),
			'later_payment_thanks_message' => esc_html__( 'Thanks message for payment', 'hbook-admin' ),
			'later_payment_store_credit_card_thanks_message' => esc_html__( 'Thanks message for adding or updating payment method', 'hbook-admin' ),
			'later_payment_form_could_not_be_loaded' => esc_html__( 'Payment form could not be loaded', 'hbook-admin' ),
			'later_payment_already_paid' => esc_html__( 'Payment already made', 'hbook-admin' ),
		);
	}

	public function get_later_payment_link_button_txt() {
		return array(
			'later_payment_pay_button_pay_txt' => esc_html__( 'Payment link button text', 'hbook-admin' ),
			'later_payment_update_button_txt' => esc_html__( 'Add or update payment method button text', 'hbook-admin' ),
		);
	}
	...
	public function get_txt_variables() {
		return array(
			...
			'later_payment_form_amount' => array( '%amount' ),
			'later_payment_type_explanation' => array( '%payment_type' ),
			'later_payment_thanks_message' => array( '%customer_email' ),
			'later_payment_store_credit_card_thanks_message' => array( '%customer_email' ),
		);
	}
	...
	public function get_string_list() {
		return array_merge(
			...
			$this->get_payments_history_table_txt(),
			$this->hbdb->get_season_names(),
			$this->get_accom_list_txt(),
			$this->get_later_payment_form_txt(),
			$this->get_later_payment_link_button_txt()
		);
	}
}