			...
			if ( count( $all_accom_in_all_languages ) > 0 ) {
				if ( function_exists( 'pll_get_post' ) ) {
					...
					printf(
						...
						'<a target="_blank" href="https://maestrel-resource-center.refined.site/space/KB/61735053/">' .
					...
					printf(
						...
						'<a target="_blank" href="https://maestrel-resource-center.refined.site/space/KB/61833368/">' .
