...
class HbAdminPageIcal extends HbAdminPage {
	...
	public function display() {
			...
			if ( $dt_stamps && $dt_stamps[0] && ( $dt_stamps[0] == $dt_stamps[1] ) ) { ?>
				<div class="hb-sync-caching-msg notice notice-error">
					...
					printf(
						...
						'<a target="_blank" href="https://maestrel-resource-center.refined.site/space/KB/63275019/">' .
		...
		?>
			...
			<p>
				<?php esc_html_e( 'You can use the following variables in the "Summary" field and the "Description" field.', 'hbook-admin' ); ?><br/>
